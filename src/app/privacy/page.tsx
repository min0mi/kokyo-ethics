    ...
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-8 text-gray-800">
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-xs sm:text-sm leading-relaxed text-gray-700">
        <section className="space-y-2">
          ...
          <p>
            「公共倫理パーフェクトマスター.com」（以下、「当サイト」）では、ユーザーの学習進捗の保存、ランキング機能の提供、お問い合わせへの対応等のために、必要最小限の利用データ（メールアドレス、ニックネーム、二つ名、学習履歴データ、IPアドレス、Cookie等）を取得・利用する場合があります。
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            会員登録を選択した場合、当サイトではSupabaseを介してメールアドレスまたはGoogleアカウントによる認証を行います。当サイト上で公開するのは、ランキング参加を有効にしたユーザーのニックネーム、学習統計、および任意で設定した二つ名に限ります。メールアドレスやGoogleアカウントのパスワードは公開しません。また、Googleアカウントのパスワードを当サイトが取得・保存することはありません。
          </p>
        </section>
