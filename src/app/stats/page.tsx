  ...
  return (
    <div className="max-w-5xl mx-auto px-3 py-5 space-y-4 text-xs text-gray-900">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 text-xs">
        ...
        <div className="bg-white border border-gray-300 p-3 rounded-xs">
          <span className="text-gray-500 block mb-1">倫理・定着完了</span>
      ...
      <div className="bg-white border border-gray-300 p-4 rounded-xs space-y-3 text-xs">
        <div className="flex justify-between items-center border-b border-gray-200 pb-2">
          <h2 className="font-bold text-gray-900 text-sm">
            公共倫理 記憶定着フェーズ内訳（全{counts.total}問）
          </h2>
...
export default function StatsPage() {
  return (
    <Suspense fallback={<div className="text-center py-10 text-xs text-gray-500">公共倫理のアナリティクスを読み込み中...</div>}>
      <EthicsStatsContent />
    </Suspense>
  );
}
