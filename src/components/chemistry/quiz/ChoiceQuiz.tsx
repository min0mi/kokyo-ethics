...
export const ChoiceQuiz: React.FC<ChoiceQuizProps> = ({
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-2 text-xs">
      {/* 問題カード */}
      <div className="space-y-3 rounded-xs border border-gray-400 bg-white p-3.5 shadow-xs sm:p-4">
        {/* 問題種別ラベル ＆ パスボタン */}
        <div className="flex items-center justify-between text-[11px] pb-1 border-b border-gray-200">
          <span className="rounded-xs border border-red-200 bg-red-50 px-1.5 py-0.5 font-bold text-red-700">
          ...
          <div className="flex items-center gap-2">
            {!isAnswered ? (
              ...
              <button
                ...
                className="flex items-center gap-0.5 rounded-xs bg-red-600 px-2.5 py-0.5 text-[10px] font-bold text-white shadow-xs hover:bg-red-700"
              >
                <span>次へ</span>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="leading-tight font-semibold"><ChemicalText text={option} /></span>
                </div>
        ...
        {isAnswered && (selectedOption !== question.correctAnswer || isPassed) && (
          <div className="pt-2 border-t border-gray-200 space-y-2.5">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-1 rounded-xs bg-red-600 py-2.5 text-xs font-bold text-white shadow-xs hover:bg-red-700"
            >
