...
interface StatsContentProps {
  defaultSubject?: 'ethics' | 'chemistry';
}

export function StatsContent({ defaultSubject }: StatsContentProps) {
  const searchParams = useSearchParams();
  const paramSubject = searchParams.get('subject');
  const initialSubject = paramSubject === 'chemistry' ? 'chemistry' : paramSubject === 'ethics' ? 'ethics' : (defaultSubject || 'ethics');
